...
#     contrasena2 = forms.CharField(label='Re Contraseña', widget=forms.PasswordInput)
...
#         model = CustomUser
#         fields = UserCreationForm.Meta.fields + ('nombre','telefono', 'email', 'fechaNacimiento','contrasena1', 'contrasena2')
